...
--
-- Host: db
-- Generation Time: Oct 23, 2020 at 07:34 AM
...
CREATE TABLE `post` (
  ...
  `alt_cover_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
...
INSERT INTO `post` (`id`, `title`, `content`, `slug`, `cover_img`, `alt_cover_img`, `created_at`, `updated_at`, `admin_id`) VALUES
